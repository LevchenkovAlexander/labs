...
//        collection = new File(System.getenv("CollectionPath"));
        collection = new File("server/src/main/resources/Collection.csv");
        try {
            readFile();
    ...
    public String field_descending_fuel_type () {
        ...
        Stream<Vehicle> stream = list.stream();
        System.out.println(stream.sorted(Comparator.comparing(Vehicle::getFuelType)));
//
